                ...
                <form onSubmit={handleSubmit} autoComplete="off">
                    ...
                    <div>
                        <div className='img-container' >
                            <img src={values.profileImage !== undefined ? values.profileImage : null} alt="profile" style={values.profileImage !== undefined ? {height:'100px', width: '100px', border: '3px black solid', borderRadius: '10px'} : {'display':'none'}} />
                        </div>
